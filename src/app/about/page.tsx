...
export default function AboutPage() {
    return (
        <>
            {/* Hero Section */}
            <div className="relative flex items-center content-center justify-center pt-24 h-dvh">
                <div
          ...
          <span
              id="blackOverlay"
              className="absolute w-full h-full bg-black opacity-65"
          ></span>
                </div>
                        ...
                        <div className="w-full px-4 ml-auto mr-auto text-center lg:w-8/12">
                            <div className="p-2">
                                <h1 className="text-5xl font-semibold text-white pb-4">
                                    Who are We?
                                    {/*<br/>*/}
                                    {/*<span className="font-bold text-[var(--autisync-gold,#b98b2f)]">We Are</span>*/}
                                </h1>
                ...
                <div className="container px-4 mx-auto">
                    <div className="flex flex-wrap items-center">
                        <div className="w-full px-4 ml-auto mr-auto md:w-5/12">
                            <div className="inline-flex items-center justify-center w-16 h-16 p-3 mb-6 text-center text-white bg-[var(--autisync-gold,#b98b2f)] rounded-full shadow-lg">
                ...
                <div className="container px-4 mx-auto">
                    <div className="flex flex-wrap text-center justify-center mb-12">
                        <div className="w-full px-4 lg:w-8/12">
                            ...
                            <p className="mt-4 text-lg text-gray-600">
                                Driving digital transformation with purpose and precision
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-wrap">
                        ...
                        <div className="w-full px-4 md:w-6/12">
                            <div className="relative flex flex-col w-full min-w-0 mb-8 break-words bg-gray-50 rounded-lg shadow-lg">
                                <div className="flex-auto px-8 py-10">
                                    <div className="inline-flex items-center justify-center w-16 h-16 p-3 mb-5 text-center text-white bg-[var(--autisync-gold,#b98b2f)] rounded-full shadow-lg">
                                        <i className="text-2xl fas fa-bullseye"></i>
                                    </div>
                                    <h6 className="text-2xl text-gray-700 mb-4">
                                        Our Mission
                                    </h6>
                                    <p className="text-gray-600 leading-relaxed">
                                        To empower service businesses with AI-driven automation,
                                        exceptional design, and robust technical infrastructure that
                                        reduces operational costs, ensures brand consistency, and
                                        drives measurable growth. We systemize success so our clients
                        ...
                        <div className="w-full px-4 md:w-6/12">
                            <div className="relative flex flex-col w-full min-w-0 mb-8 break-words bg-gray-50 rounded-lg shadow-lg">
                                <div className="flex-auto px-8 py-10">
                                    <div className="inline-flex items-center justify-center w-16 h-16 p-3 mb-5 text-center text-white bg-gray-700 rounded-full shadow-lg">
                                        <i className="text-2xl fas fa-eye"></i>
                                    </div>
                                    <h6 className="text-2xl text-gray-700 mb-4">
                                        Our Vision
                                    </h6>
                                    <p className="text-gray-600 leading-relaxed">
                                        ...
                                        recognized for delivering integrated solutions that combine
                                        cutting-edge technology with creative excellence. We envision
                                        a future where every business, regardless of size, has access
                                        to enterprise-grade automation and design.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-wrap">
                        ...
                        <div className="w-full px-4 md:w-4/12 mb-8">
                            <div className="text-center">
                                <div className="inline-flex items-center justify-center w-20 h-20 p-3 mb-5 text-center text-white bg-red-400 rounded-full shadow-lg">
                        ...
                        <div className="w-full px-4 md:w-4/12 mb-8">
                            <div className="text-center">
                                <div className="inline-flex items-center justify-center w-20 h-20 p-3 mb-5 text-center text-white bg-[var(--autisync-gold,#b98b2f)] rounded-full shadow-lg">
                        ...
                        <div className="w-full px-4 md:w-4/12 mb-8">
                            <div className="text-center">
                                <div className="inline-flex items-center justify-center w-20 h-20 p-3 mb-5 text-center text-white bg-gray-700 rounded-full shadow-lg">
                        ...
                        <div className="w-full px-4 md:w-4/12 mb-8">
                            <div className="text-center">
                                <div className="inline-flex items-center justify-center w-20 h-20 p-3 mb-5 text-center text-white bg-blue-500 rounded-full shadow-lg">
                        ...
                        <div className="w-full px-4 md:w-4/12 mb-8">
                            <div className="text-center">
                                <div className="inline-flex items-center justify-center w-20 h-20 p-3 mb-5 text-center text-white bg-green-500 rounded-full shadow-lg">
                        ...
                        <div className="w-full px-4 md:w-4/12 mb-8">
                            <div className="text-center">
                                <div className="inline-flex items-center justify-center w-20 h-20 p-3 mb-5 text-center text-white bg-purple-500 rounded-full shadow-lg">
            ...
            <section className="py-20 bg-white">
                <div className="container px-4 mx-auto text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        <Link href="/contact">
                            <button className="px-6 py-2 text-white bg-[var(--autisync-gold,#b98b2f)] rounded-md shadow-lg hover:bg-gray-900 transition">
                                Get in Touch
                            </button>
                        </Link>
                        <Link href="/servicepackage">
                            <button className="px-6 py-2 text-gray-700 bg-gray-100 rounded-md shadow-lg hover:bg-gray-200 transition">
                                View Our Services
                            </button>
                        </Link>
                    </div>
