        ...
        <div className="container px-4 mx-auto">
          <div className="flex flex-wrap justify-center mb-24 text-center">
            <div className="w-full px-4 lg:w-8/12">
              ...
              <button className="inline-flex justify-center px-4 py-2 text-sm font-medium hover:text-gray-50 text-[var(--autisync-gold,#b98b2f)] bg-gray-50 border border-transparent rounded-md shadow-lg hover:bg-[var(--autisync-gold,#b98b2f)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                <Link href={"/about"}>
                  Meet the Team
                </Link>
              </button>
